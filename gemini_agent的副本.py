...
{{
    ...
    "技术与属性": {{
        ...
        "AI模型": ["Wenxin Yiyan (文心一言)", "Tongyi Qianwen (通义千问)", "Doubao (豆包)", "Hunyuan (混元)", "Kimi (Kimi 智能助手)", "DeepSeek (深度求索)", "GLM / ChatGLM (智谱清言)", "MiniMax / Hailuo (海螺)", "海螺2.3", "Yi (万知)", "SenseNova (日日新)", "Spark (星火认知)", "Step (阶跃星辰)", "Baichuan (百川)", "ChatGPT", "Claude", "Gemini", "Copilot", "Grok", "Perplexity", "Poe", "Reka", "Command", "LTX2", "Qwen (通义)", "DeepSeek (开源版)", "ChatGLM / GLM (开源)", "Yi (开源版)", "InternLM (书生·浦语)", "Baichuan (开源版)", "Aquila (悟道·天鹰)", "TeleChat", "Skywork (天工)", "Yuan (源)", "MapNEO", "Llama", "Mistral / Mixtral", "Gemma", "Falcon", "Phi", "Jamba", "Nemotron", "Command R", "OLMo", "Wan (万相)", "Kling (可灵)", "Vidu", "CogVideo", "Kolors (可图)", "PixArt", "CodeGeeX", "MarsCode", "CosyVoice", "ChatTTS", "Midjourney", "Sora", "Runway Gen", "Pika", "Luma Dream Machine", "Stable Diffusion", "FLUX", "Suno", "Udio", "ElevenLabs", "Whisper", "Codex / GitHub Copilot", "LongCat", "/"],
...
- 如果没有提到具体模型，使用"未知"
- 可识别的模型包括：Wenxin Yiyan (文心一言), Tongyi Qianwen (通义千问), Doubao (豆包), Hunyuan (混元), Kimi, DeepSeek, GLM/ChatGLM, MiniMax/Hailuo, 海螺2.3, Yi, SenseNova, Spark, Step, Baichuan, ChatGPT, Claude, Gemini, Copilot, Grok, Perplexity, Poe, Reka, Command, LTX2, Qwen, InternLM, Llama, Mistral, Gemma, Falcon, Phi, Jamba, OLMo, Wan, Kling, Vidu, CogVideo, Midjourney, Sora, Stable Diffusion, FLUX, Suno, Udio, Whisper, LongCat等
"""
